...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { comment: @instructor.comment, email: @instructor.email, first: @instructor.first, last: @instructor.last, middle: @instructor.middle, uniq_id: @instructor.uniq_id } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { comment: @instructor.comment, email: @instructor.email, first: @instructor.first, last: @instructor.last, middle: @instructor.middle, uniq_id: @instructor.uniq_id } }
